...
#                        self.agg_switches[switch + i])
        ...
        self.addLink(self.core_switches[0], self.agg_switches[1])
        self.addLink(self.core_switches[0], self.agg_switches[2])
        self.addLink(self.core_switches[0], self.agg_switches[4])
        self.addLink(self.core_switches[0], self.agg_switches[6])

        self.addLink(self.core_switches[1], self.agg_switches[0])
        self.addLink(self.core_switches[1], self.agg_switches[2])
        self.addLink(self.core_switches[1], self.agg_switches[4])
        self.addLink(self.core_switches[1], self.agg_switches[6])

        self.addLink(self.core_switches[2], self.agg_switches[0])
        self.addLink(self.core_switches[2], self.agg_switches[3])
        self.addLink(self.core_switches[2], self.agg_switches[5])
        self.addLink(self.core_switches[2], self.agg_switches[7])

        self.addLink(self.core_switches[3], self.agg_switches[1])
        self.addLink(self.core_switches[3], self.agg_switches[3])
        self.addLink(self.core_switches[3], self.agg_switches[5])
        self.addLink(self.core_switches[3], self.agg_switches[7])
...
#        self.delLinkBetween(self.agg_switches[0], self.edge_switches[11111111111])
